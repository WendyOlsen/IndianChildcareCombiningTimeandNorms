...
use "data\temp.dta", clear
collect:  table  edu [pweight=w]  , stat(mean  age rural)  stat(sd age rural)  stat(n age rural) nformat(%9.2f) 
collect export "results\IndiaGNTablesAsianBarom.xlsx", sheet(Table 3) modify cell(c6) 
putexcel set "results\IndiaGNTablesAsianBarom.xlsx" , sheet("Table 3") modify
putexcel d7:ad7 , txtwrap
putexcel A2 = "Mean of Age and Proportion Rural by Education"
putexcel a3 = "Asian Barometer Data 2019"
putexcel a4 = "All respondents"
putexcel a5= "Please note the gender norm index ran from -3 to +3 approximately"
putexcel save
